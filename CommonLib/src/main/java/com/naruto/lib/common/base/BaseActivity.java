...
public abstract class BaseActivity extends AppCompatActivity implements BaseView {
    ...
    public AlertDialog showGoToSettingPermissionDialog(RequestPermissionsCallBack callback, List<String> deniedPermissions, String requestPermissionReason) {
        ...
        AlertDialog permissionDialog = DialogFactory.Companion.makeGoSettingDialog(this
                ...
                , () -> {
                    callback.onDenied(this, deniedPermissions);
                ...
                , result -> {
                    if (checkPermissions(callback.getRequestPermissions()).isEmpty()) {//已获取权限
                        ...
                        callback.onDenied(BaseActivity.this, deniedPermissions);
                    }
                });
    ...
    public AlertDialog showPermissionRequestReasonDialog(RequestPermissionsCallBack callback, List<String> deniedPermissions, String requestPermissionReason) {
        ...
        dialogData.setCancelListener((v) -> callback.onDenied(this, deniedPermissions));
